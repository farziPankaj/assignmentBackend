...
const validateId = async (req, res, next) => {
    await checkSchema({
        id: {
            ...
            trim: true,
            isString: {
                errorMessage: `Idd must of type string`,
                bail: true 
            },
            isUUID: {
                errorMessage: `Id must be an UUID`,
                bail: true
            },
            escape: true
        },
...
const validateManufacturerDetails = async(req, res, next) => {
    await checkSchema({
        name: {
            in: ['body'],
            trim: true,
...
const validateEquipmentDetails = async(req, res, next) => {
    await checkSchema({
        model: {
            ...
            isString: {
                errorMessage: `Model must of type string`,
                bail: true 
            },
            isLength: {
                options: { 
                ...
                errorMessage: `Model should be in range 4 to 20 characters`,
                bail: true
            },
            escape: true
        },
        serialNumber: {
            ...
            trim: true,
            notEmpty: { 
                errorMessage: `Serial Number must not be empty`,
                bail: true 
            },
            isString: {
                errorMessage: `Serial Number must of type string`,
                bail: true 
            },
            isLength: {
                options: { 
                ...
                errorMessage: `Serial Number should be in range 4 to 20 characters`,
                bail: true
            },
            escape: true
        }
